...
| Skill | What it does |
|-------|-------------|
| [uk-tax-calculator](skills/uk-tax-calculator.md) | Calculate Income Tax, NI, VAT tracking, and MTD summaries for 2025/26 |
| [proposal-generator](skills/proposal-generator.md) | Generate client-ready proposals, scopes of work, and project quotes |
| [client-comms-drafter](skills/client-comms-drafter.md) | Draft professional client emails — updates, payment chasing, scope pushback |
| [invoice-expense-categoriser](skills/invoice-expense-categoriser.md) | Categorise expenses against HMRC Self Assessment boxes with MTD-ready reports |
...
| Skill | What it does |
|-------|-------------|
| [uk-landlord-compliance](skills/uk-landlord-compliance.md) | Section 8 notices, tenancy agreements, deposit docs, and all 37 grounds under the Renters' Rights Act 2025 |
| [property-rental-yield](skills/property-rental-yield.md) | Rental yield calculations, stamp duty, ROI projections, and property listing copy |
...
| Skill | What it does |
|-------|-------------|
| [construction-quote](skills/construction-quote.md) | Itemised construction quotes with material lists, labour rates, and additional costs |
| [food-hygiene-haccp](skills/food-hygiene-haccp.md) | HACCP plans, allergen matrices, cleaning schedules, and EHO inspection prep |
...
1. Download the `.md` file for the skill you need
2. Place it in your Claude Code project directory (or `.claude/commands/`)
3. Invoke it by name — Claude Code reads the skill and follows its instructions

These are Claude Code custom slash commands. They work with any Claude Code setup.
...
Lite versions are free for personal and commercial use. Full versions are licensed per user.
