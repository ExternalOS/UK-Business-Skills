...
## Legislation Reference Index

| Statute | Key Provisions |
|---------|----------------|
| Housing Act 1988 (as amended) | Assured tenancies, Section 8 grounds, Schedule 2 |
| Renters' Rights Act 2025 | Section 21 abolition, reformed grounds, periodic tenancies, PRS database |
| Housing Act 2004 | HMO licensing, deposit protection, HHSRS |
| Immigration Act 2014 | Right to Rent checks |
| Tenant Fees Act 2019 | Prohibited payments, permitted payments |
...
Grounds 1, 1A, and 6 cannot be used within the first 12 months of the tenancy.
...
| Ground | Description | Notice Period |
|--------|-------------|---------------|
| **10** | Some rent arrears (any amount) | 4 weeks |
| **11** | Persistent delay in paying rent | 4 weeks |
| **12** | Breach of tenancy obligation | 2 weeks |
| **14** | Nuisance, annoyance, or illegal use | 2 weeks |

---

## 2. Key Changes Under Renters' Rights Act 2025

From 1 May 2026:
- **All new tenancies are periodic from day one.** Fixed-term ASTs are abolished.
- **Tenants may end a periodic tenancy** by giving **2 months' notice** at any time.
- **Landlords** must use Section 8 grounds to end a tenancy.
- **Deposit cap:** 5 weeks' rent (annual rent below £50,000) or 6 weeks' rent.

---

## Rules

1. **Cite legislation** for every document generated.
2. **UK English throughout.**
3. **Disclaimer on every output.**
4. **Specify the correct notice period** for every ground relied upon.

---

*This is the lite version. The full version includes all 37 grounds for possession with detailed requirements, Section 8 notice template (Form 3), complete tenancy agreement template with all mandatory clauses, Tenant Information Sheet compliance checklist, Right to Rent check procedure with document lists and penalty schedule, deposit prescribed information template, rent increase procedure (Section 13), safety certification tracker (gas, electrical, EPC, smoke/CO), HMO licensing requirements, Decent Homes Standard obligations, and the PRS database registration procedure. Available at https://gumroad.com/l/PLACEHOLDER-landlord.*
