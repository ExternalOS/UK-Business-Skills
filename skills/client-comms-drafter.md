...
1. **Never use placeholders.** If you don't have a name, use "Hi there" not "Hi [NAME]".
2. **UK English by default.** Colour, organise, specialise.
...
6. **Keep it short.** Most client emails should be under 200 words.
